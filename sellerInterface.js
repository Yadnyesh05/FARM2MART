const districts = {
    "Andhra Pradesh": [
        ...
        "Nandyal", "Nellore", "Palnadu", "Parvathipuram", "Prakasam", "Srikakulam",
...
function updateDistricts() {
    ...
    // If state is selected, populate district dropdown
...
// ---------------------------------------------------------------------------------------------------
const Products = {
    "Grains": ["rice", "wheat", "corn", "oats", "barley", "millet", "quinoa", "rye"],
    "Fruits": ["apple", "banana", "guava", "orange", "mango", "grape", "pear", "pineapple", "strawberry", "watermelon"],
    "Vegetables": ["carrot", "potato", "tomato", "broccoli", "spinach", "cauliflower", "onion", "bell pepper", "cucumber", "peas"]
...
function updateProducts() {
    ...
    // If state is selected, populate district dropdown
    if (selectedProductType && Products[selectedProductType]) {
        Products[selectedProductType].forEach(Product => {
            let option = document.createElement("option");
